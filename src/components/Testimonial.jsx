...
const Testimonial = () => {
  ...
  return (
     <div className="py-28 px-6 md:px-16 lg:px-44">
            <Title title="What Our Customers Say?" subTitle="Discover why discerning travellers choose Stay Venture for their Luxary accomodations sround the world " />
