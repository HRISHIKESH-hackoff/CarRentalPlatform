...
const Footer = () => {
  return (
    ...
    <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 max-w-full'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                ...
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center mt-4'>
                        ...
                        <button className='flex items-center justify-center text-white bg-blue-600 h-9 w-9 aspect-square rounded-r'>
                            {/* Arrow icon */}
