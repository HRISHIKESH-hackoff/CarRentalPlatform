...
const Cars = () => {
  ...
  return (
    <div >
      <div className='bg-blue-50 flex flex-col items-center py-20 bg-light max-md:px-4'>
      ...
      <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-10'>
        <p className='text-gray-500 xl:px-20 max-w-7xl max-auto'>Showing {dummyCarData.length}</p>
